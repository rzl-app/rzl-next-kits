 ...
 * -------------------------------------------------------------------
 * * ***This function is return `PageContextProvider` from [next-extra](https://www.npmjs.com/package/next-extra).***
...
function PageContextProvider<T extends Context = Context>(props: PageContextProps<T>) {
  ...
  return React.createElement(PageContext.Provider, { value: data }, [
